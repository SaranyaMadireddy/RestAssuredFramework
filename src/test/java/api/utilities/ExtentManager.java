...
//	private static Map<Long, WebDriver> driverMap = new HashMap<>();
	...
	public synchronized static ExtentReports getReporter() {
		if (extent == null) {
			...
			spark.config().setDocumentTitle("PetStore Report");
	 ...
	 * String screenshotMessage) { getTest().pass(logMessage); // Test Level
	 * screenshot // screenshot method attachScreenshot(driver, screenshotMessage);
...
/*		return base64Format;
	...
	/*
	 * public synchronized static void attachScreenshot(WebDriver driver, String
	 * message) { try { String screenShoteBase64 = takeScreenshot(driver,
	 * getTestName()); getTest().info(message,
	 * com.aventstack.extentreports.MediaEntityBuilder
	 * .createScreenCaptureFromBase64String(screenShoteBase64).build()); } catch
	 * (Exception e) { getTest().fail("Fail to attach screenshot:" + message);
	 * e.printStackTrace(); } }
	 */
